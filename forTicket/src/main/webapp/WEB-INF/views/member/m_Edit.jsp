...
<form method="GET"   action="${contextPath}/member/updateMember.do">
	...
	<input type="submit" onclick="fn_withdraw()" value="탈퇴하기">
</form>
</div>
...
function fn_withdraw() {
    var confirmWithdraw = confirm("정말로 탈퇴하시겠습니까?");
    if (confirmWithdraw) {
        alert("탈퇴되었습니다.");
        window.location.href = "${contextPath}/admin/deleteMember.do?mem_id=${taget.mem_id}";
    }
}

//수정하기 버튼 클릭 시 처리
function fn_sub(form) {
