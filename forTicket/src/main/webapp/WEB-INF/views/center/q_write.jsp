...
<div class="center">
    ...
    <form name = "wirte" method="post" action="${contextPath }/center/addQue.do">
		<table class="tb1">
			<tr>
				<td class="td1">작성자</td>
				<td class="td2"><input type="text" name="mem_id" value="${member.mem_id}" readonly/></td>
			</tr>
			<tr>
				<td class="td1">제목</td>
				<td class="td2"><input type="text" size ="63" maxlength="500" name="q_Title" /></td>
			</tr>
			<tr>
				<td class="td1">내용</td>
				<td class="td2"><textarea name="q_content" rows ="10" cols="65" maxlength="4000"></textarea></td>
			</tr>
			<tr>
