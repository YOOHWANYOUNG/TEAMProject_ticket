...
<body>
	<div class="wrap_1100">
		<div class="main_title">공연장 목록 > ${theater_name}</div><hr>
		<div style="margin-top: 25px;">
			<form name="frmTheater" method="post" action="${contextPath}/theater/addTheater.do" encType="multipart/form-data">
						...
						<td valign="top" align="left">
							<div class="theater_list">
								<div class="theater_info">
									...
									<textarea name="theater_detail" id="inputDetail"></textarea></label>
									<label for="inputAddress" class="detail">공연장 주소 : 
									<input type="text" name="theater_address" id="inputAddress"/>
